...
function suzette_scripts() {
  ...
  wp_enqueue_style(
    'flickity-style', //handle
    "http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://unpkg.com/flickity@2/dist/flickity.min.css",  //source
    null, // version number
    ...
    wp_enqueue_script(
  	'image-loaded',
  	"http" . ($_SERVER['SERVER_PORT'] == 443 ? "s" : "") . "://unpkg.com/imagesloaded@4/imagesloaded.pkgd.min.js",
  	false, //dependencies
  	null, //version number
  	true //load in footer
  );
